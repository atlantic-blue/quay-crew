...
Sections 11 to 14 were added later and each carries its own, which takes the file to sixteen. An
earlier version of this paragraph said ten, and the count had gone stale.

Every one of the sixteen was parsed by mermaid's own parser on the day the overview in section 3
