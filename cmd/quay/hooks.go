...
const staleWarning = "threads already running are not under it: a hook reaches a sandbox when the sandbox is built, so stop and restart a thread to put it under this one"
