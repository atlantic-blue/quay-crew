...
func jobFlagsTaken() map[string]bool {
	...
	for _, name := range []string{
		...
		flagProduct,
		flagAfter, flagDeadline, flagBudgetTokens, flagLabel, flagRequires, flagPhase, flagOutcome, flagRoots,
