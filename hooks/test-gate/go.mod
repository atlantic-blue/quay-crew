// The hook is its own module, the same way the merge gate and the process gate are. It is a plugin:
...
module github.com/atlantic-blue/quay-krewe/hooks/test-gate
