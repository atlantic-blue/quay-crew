// The hook is its own module, the same way the merge gate is. It is a plugin: something somebody
...
module github.com/atlantic-blue/quay-krewe/hooks/prose-gate
