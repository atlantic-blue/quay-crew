...
// eight hex characters is four billion values: ample for the number of projects and sessions one
...
// whose project has since been deleted. Neither is ever blank, because a blank cell reads as a bug.
