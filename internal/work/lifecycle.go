...
// from the work that names it, which is why this belongs to the same loop rather than to a second
// one, and why the controller keeps nothing in memory between ticks.
//
// The rule, in three lines:
//
//   - A session named by work in a non terminal phase is wanted alive, and nothing here touches it.
