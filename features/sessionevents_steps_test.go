...
// is that the crew says what happened to a session, in order, whether or not a broker is listening.
...
// the case where the events matter most. So a scenario with no landed task asks for the whole crew's
