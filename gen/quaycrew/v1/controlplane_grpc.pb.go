...
type ControlPlaneServiceClient interface {
	...
	//
	// ApproveDesign is refused to the driver. The approval is what says work may be built from the
	// design, so a session that could approve one would be approving its own.
