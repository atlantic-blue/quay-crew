...
- `claimWidth` in `cmd/krewe/job.go`, 28 characters: cut for display. The claim shares a line with
  the title.
- `reasonWidth` in `cmd/krewe/job.go`, 40 characters: cut for display. The reason a job stopped or
  failed shares a line with the title, and `krewe job show` keeps the whole of it.
