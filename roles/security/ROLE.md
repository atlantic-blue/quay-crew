...
Krewe does not stop this role from fixing the code instead of writing the failing test that proves the defect. `CLAUDE.md` is a file a repository may not have, and this system does not write it.
